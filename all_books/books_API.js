let bookData = [
    {
        img: "./bookImages/aob1_1.png",
        genre: ["Fantasy", "School", "Magic", "Isekai"],
        ...
        volumes: [
            ...
            {
                img: "./bookImages/aob2_1.png",
                name: "Part 2 Volume 1",
                description:
            ...
            {
                img: "./bookImages/aob2_2.png",
                name: "Part 2 Volume 2",
                description:
            ...
            {
                img: "./bookImages/aob3_2.png",
                name: "Part 3 Volume 2",
                description:
            ...
            {
                img: "./bookImages/aob3_3.png",
                name: "Part 3 Volume 3",
                description:
            ...
            {
                img: "./bookImages/aob4_1.png",
                name: "Part 4 Volume 1",
                description:
            ...
            {
                img: "./bookImages/aob4_2.png",
                name: "Part 4 Volume 2",
                description:
            ...
            {
                img: "./bookImages/aob4_3.png",
                name: "Part 4 Volume 3",
                description:
            ...
            {
                img: "./bookImages/aob4_7.png",
                name: "Part 4 Volume 7",
                description:
            ...
            {
                img: "./bookImages/aob4_8.png",
                name: "Part 4 Volume 8",
                description:
            ...
            {
                img: "./bookImages/aob4_9.png",
                name: "Part 4 Volume 9",
                description:
            ...
            {
                img: "./bookImages/aob5_1.png",
                name: "Part 5 Volume 1",
                description:
            ...
            {
                img: "./bookImages/aob5_2.png",
                name: "Part 5 Volume 2",
                description:
            ...
            {
                img: "./bookImages/aob5_3.png",
                name: "Part 5 Volume 3",
                description:
            ...
            {
                img: "./bookImages/aob5_4.png",
                name: "Part 5 Volume 4",
                description:
                    "Upon returning to Ehrenfest, Rozemyne is given a harsh choice to make. The winter purge has made the Leisegangs the dominant power, and their intentions sow distrust within the archducal family. Still, she continues to forge ahead, her way of life gradually inspiring change around her. The feast in celebration of spring is drawing near, and there’s much for Rozemyne to do. The coming weeks bring a long-overdue meeting with the lower-city merchants, more divine protections rituals, the education of the next High Bishop... and a magnificent tale told at the closed country gate. It now falls to the archducal family to overcome history and the divide between factions. Ehrenfest’s ambitious younger generation unites in the newest volume of this biblio-fantasy. Includes two short stories and four-panel manga by You Shiina.",
                downloadLink: "",
            },
            {
                img: "./bookImages/aob5_5.png",
                name: "Part 5 Volume 5",
                description:
                    "Spring is in full bloom, and Rozemyne is summoned to the Archduke Conference. She performs the Starbind Ceremony as High Bishop, then rests and recuperates by transcribing documents in the library’s underground archive. The ceremony has some unforeseen consequences, however. As tensions rise over the increasingly important “Zent candidates,” Rozemyne finds herself entangled in the web of royal politics. Thankfully, this also secures her the chance to bargain with one of the princes... “When you get an opportunity, take it and profit as much as you possibly can, right? Well, here I go!” Negotiations are underway in the newest volume of this biblio-fantasy! What techniques will the commoner-born merchant saint unleash?! Includes two short stories and four-panel manga by You Shiina.",
                downloadLink: "",
            },
            {
                img: "./bookImages/aob5_6.png",
                name: "Part 5 Volume 6",
                description:
            ...
            {
                img: "./bookImages/aob5_7.png",
                name: "Part 5 Volume 7",
                description:
                    "Ferdinand senses danger on the horizon. Dark clouds hang over him, twisting and turning into a dense miasma of unease. Meanwhile, Rozemyne prepares for winter, conscious that her move to the Sovereignty is fast approaching. Her fourth term at the Royal Academy begins, she meets new faces at the fellowship gathering... Then something strange happens. Rozemyne goes somewhere unexpected, where she finds something even more unexpected—and that’s only the beginning. How will the saint respond when an incident in Ahrensbach leaves everyone else feeling defeated? “No matter what happens, I’ll protect you.” Pressing events are set in motion in the newest volume of this biblio-fantasy. Includes two short stories and four-panel manga by You Shiina.",
                downloadLink: "",
            },
            {
                img: "./bookImages/aob5_8.png",
                name: "Part 5 Volume 8",
                description:
                    "“I’ll do anything to save him. Anything.” Greater duchies, the Sovereignty, the royal family, even the gods themselves—Rozemyne will take on anyone in her quest to rescue Ferdinand. She uses her newly acquired Book of Mestionora to activate Kirnberger’s long-dormant country gate. Then, with Dunkelfelger on her side, she speeds to Ahrensbach even faster than Steifebrise. To war! As the battle against Lanzenave commences, Georgine finally begins her invasion and triggers the Defense of Ehrenfest. Can the combined forces of the temple and the lower city’s commoners help keep the duchy safe? And can Rozemyne secure victory in this game of true ditter?! The newest volume of this biblio-fantasy contains more than one hundred pages of original content not featured in the web novel. And as always, look forward to more four-panel manga by You Shiina!",
                downloadLink: "",
            },
            {
                img: "./bookImages/aob5_9.png",
                name: "Part 5 Volume 9",
                description:
                    "The Battle of Gerlach begins at last. Together with Matthias, Rozemyne must defeat the cold-blooded giebe Grausam—but an unexpected development makes that easier said than done. Body doubles, collateral damage, even more dark plots transpiring in the shadows... How does their inevitable battle play out, and what happens to Ehrenfest in the aftermath? Behold the full extent of the explosive war shaking Yurgenschmidt to its very foundation! Time is running out in the newest installment of this biblio-fantasy. Once again, this volume contains more than one hundred pages of original content not featured in the web novel—and more four-panel manga by You Shiina!",
                downloadLink: "",
            },
            {
                img: "./bookImages/aob5_10.png",
                name: "Part 5 Volume 10",
                description:
            ...
            {
                img: "./bookImages/aob5_11.png",
                name: "Part 5 Volume 11",
                description:
                    "Striving to change Yurgenschmidt for the better, Ferdinand starts a revolution that will abolish the distorted royal family and put a true Zent on the throne. Not everyone is on board, however, and as the Grutrissheit transference ceremony draws near, Rozemyne continues to wrestle with divine interference. Unease spreads, but not for our resident bookworm; the future she envisions is much too exciting. Operation Library City is just within reach! The conclusion to Part 5 approaches in the newest volume of this biblio-fantasy. Features two original short stories and more four-panel manga by You Shiina.",
                downloadLink: "",
            },
            {
                img: "./bookImages/aob5_12.png",
                name: "Part 5 Volume 12",
                description:
                    "Rozemyne fell unconscious upon completing her large-scale spell. Now it falls to Ferdinand to bring her back from the brink of death—and, with any luck, restore her lost memories. If she survives, she will set out on a new journey as Yurgenschmidt’s first underage aub and rule over the library city of Alexandria. If not, her death will mean the worst for her loved ones and the country at large. “Let everyone... be blessed.” This volume concludes the biblio-fantasy that refused to let dreams remain dreams. In addition to a massive amount of original content, look forward to more four-panel manga and an extended comic by You Shiina.",
                downloadLink: "",
            },
        ],
        price: "₹396.42",
    },
    {
        ...
        volumes: [
            ...
            {
                img: "./bookImages/tensura_10.png",
                name: "Volume 10",
                description:
                    "The Tempest Founder's Festival was a roaring success, and after working out a few kinks, the advanced Dungeon is proving to be a major Tempest tourist attraction. Now Rimuru's next objective is to join the infamous Council of the West—however, a certain influential figure working from the shadows of the Council has no intention of allowing someone as powerful as Rimuru to take a seat at the table, and she will stop at nothing to quietly snuff him out before he makes any moves!",
                downloadLink: "",
            },
            {
                img: "./bookImages/tensura_11.png",
                name: "Volume 11",
                description:
                    "Rimuru and his team are headed for the Holy Empire of Lubelius to organize the concert he promised Luminous, its leader. But as preparations continue, a fiendish conspiracy involving both demon lords is being laid out behind the scenes. There may not be much time for music after all…especially with a third demon lord on the hunt for a certain otherworlder in Rimuru's care!",
                downloadLink: "",
            },
            {
                img: "./bookImages/tensura_12.png",
                name: "Volume 12",
                description:
                    "Threatened by Tempest's continued rapid expansion, the Eastern Empire finally starts setting the stage for all-out war with the monster nation. According to Chloe, the time-traveling chosen hero, there exists a timeline in which the Empire kills Rimuru and Tempest subsequently collapses. While Rimuru's doom isn't set in stone, his victory isn't a foregone conclusion either. This may be a different timeline, but the slime demon lord nonetheless steps up his guard—and just as he does, several Imperial spies infiltrate Tempest…",
                downloadLink: "",
            },
            {
                img: "./bookImages/tensura_13.png",
                name: "Volume 13",
                description:
                    "The Eastern Empire's vast army (over 900,000 strong) is ready to invade the Forest of Jura. Thanks to Ramiris' mind-boggling powers, Tempest's entire capital—buildings, inhabitants, and all—has been evacuated into the nation's labyrinthine Dungeon. While Primordial Daemons Testarossa and Ultima kick some serious imperial butt over on the front lines, the rest of the Empire's army attempts to storm the Dungeon. Little does the enemy know, however, that they're about to face a devastating bloodbath at the hands of Tempest's own mighty forces…",
                downloadLink: "",
            },
            {
                img: "./bookImages/tensura_14.png",
                name: "Volume 14",
                description:
            ...
            {
                img: "./bookImages/tensura_15.png",
                name: "Volume 15",
                description:
                    "Following a fierce battle against his sister Velgrynd, Rimuru's steadfast ally Veldora has fallen into the enemy's clutches. An enraged Rimuru gives the order to massacre his foes, a request his Tempest top brass couldn't be more thrilled to oblige. Once Rimuru's daemon underlings evolve en masse, the final battle between Tempest and the Eastern Empire will begin in earnest. But if Rimuru wants to save Veldora, he'll need to undergo an evolution of his own. It's time to unleash the power he's been holding back!",
                downloadLink: "",
            },
            {
                img: "./bookImages/tensura_16.png",
                name: "Volume 16",
                description:
                    "Rimuru has emerged victorious in the war against the Eastern Empire, but between the ultimate skill Michael hijacking Emperor Rudra's body and the Specter Lord Feldway's secret machinations, he still has a lot left on his plate. Plus, a recent fight at the Dungeon—which occurred while Rimuru was busy with his own climactic battle—revealed serious flaws in Tempest's defenses. Now that he's finally got a moment to breathe, it's time for everyone's favorite slime to address some major infrastructure issues with his team…",
                downloadLink: "",
            },
            {
                img: "./bookImages/tensura_17.png",
                name: "Volume 17",
                description:
                    "The series' first short story collection takes a deep dive into the epic tale's fantasy world—and what its characters get up to when Rimuru isn't running the show! Gard Mjöllmile, the most powerful human member of Tempest's government, is up to some less-than-proper dealings in the Western Nations; Velgrynd gets involved with a familiar-looking planet as she traces the trail of her lover; Calgurio starts facing up to his past as he strives to rebuild the Empire; and Rain, Primordial Daemon servant of the demon lord Guy Crimson, has a complaint or two about her toxic work environment. All that plus an extra tale you won't want to miss in this stellar collection!",
                downloadLink: "",
            },
            {
                img: "./bookImages/tensura_18.png",
                name: "Volume 18",
                description:
            ...
            {
                img: "./bookImages/tensura_19.png",
                name: "Volume 19",
                description:
                    "Rimuru and his forces fight heroically on all fronts to stop Michael's plan…only to lose the demon lord Leon to Feldway's schemes. Michael's next target is Masayuki the Hero, who possesses the soul of Rudra, Michael's former host. There to meet him in battle are the paladin Hinata, the Primordial Daemon Blanc, and Velgrynd the Scorch Dragon. But just when Michael begins to set things in motion, the situation devolves even further into chaos…",
                downloadLink: "",
            },
            {
                img: "./bookImages/tensura_20.png",
                name: "Volume 20",
                description:
                    "Although Rimuru managed to defeat his archenemy Michael, battles continue to rage across the land, and the fighting between Milim's forces and the insectars is particularly chaotic. Just when the outcome looks to be in Milim's favor, a beautiful woman of ice and snow appears, drastically altering the tides of the war. She is none other than Velzard, the eldest of the only three True Dragons in existence. Once Velzard overwhelms the situation, encasing everything in ice, Milim begins to go on a rampage—and Rimuru has no choice but to return to the battlefield to stop her.",
                downloadLink: "",
            },
        ],
        price: "₹382.60",
    ...
    {
        img: "./bookImages/cleric_1.png",
        genre: ["Isekai", "Fantasy", "Action", "Magic"],
        ...
        volumes: [
            ...
            },
            {
                ...
                name: "Volume 7",
                description:
                    "Saint Weirdo returns to the Holy City, and surely a few months of peace and calm await the masochist healer back on his own turf. This time, for sure! Yeah, right. Luciel’s homecoming is less a vacation and more a pitstop on his never-ending list of responsibilities as an S-rank healer. The enigma that is Estia and her connection to the mysterious Lihzalea loom in the background, as all the while the Church continues to reel under the changes its newest S-rank brought so suddenly. The captain of the guard can scarcely get a grip in the wake of such greatness, and in her desperation to match the Saint’s accomplishments, she just might do something drastic. Meanwhile, the shadows in the dark are always lurking, but closer than ever before...perhaps beneath their very feet.",
                downloadLink: "",
            },
            {
                img: "",
                name: "Volume 8",
                description:
                    "There’s no time to lose. Luciel and the gang make for Grandol with all haste, on a heroic quest to save a damsel in distress...not. The hapless healer is in no rush to go sticking his neck out for others, but he’s not one to break a promise to an all-powerful dragon. When they arrive, though, things don’t exactly go as planned, and a detour takes Luciel on yet another rescue mission—this time at an auction. But a bid war is only marginally less lethal than a labyrinth, especially when it’s being run by a shady character who seems to know more than he lets on. And that’s the least of the poor S-rank’s worries. With Brod back around, class is about to be back in session, and it’s looking to be the hardest course in brutality Luciel’s ever taken. Meanwhile, the healer wonders what it is that keeps making him the center of chaos. Is it the mere whimsy of fate? Or he himself? And what happens when it puts the people he cares about in danger?",
                downloadLink: "",
            },
            {
                img: "",
    ...
    {
        img: "./bookImages/tsukimichi_1.jpg",
        genre: [
            "Isekai",
            "Fantasy",
            "Action",
        ...
        volumes: [
            ...
            },
            {
                ...
                name: "Volume 4",
                description:
                    "Makoto, an ordinary high school student who was suddenly summoned to another world, successfully resolved his dispute in Ziege and resumed his unusual journey towards his next destination, the academic city of Lotsgard. However, during the journey, he loses consciousness and is abducted by someone. I ended up in the middle of a battlefield. And right in front of him, a mysterious woman with a ferocious smile was poised to swing a great sword at Makoto. Will Makoto Fukasumi, an unfortunate child who attracts trouble, be able to get through this biggest crisis?",
                downloadLink: "",
            },
            {
                img: "",
                name: "Volume 5",
                description:
                    "After overcoming various hardships, Makoto is an ordinary high school student who finally reaches his destination, the academic city of Lottsgard. He was planning to enroll as a student at a 'school' that existed in this land in order to expand his knowledge of other worlds. However, the test that he actually took was not an entrance exam, but a teacher employment exam for some reason. The strange school life of Makoto Fukasumi, a disappointing child who attracts trouble, begins!!",
                downloadLink: "",
            },
        ],
        price: "₹319.79",
    ...
    {
        img: "./bookImages/isekai_tensei_1.jpg",
        genre: ["Isekai", "Fantasy", "Action", "Magic"],
        title: "Isekai Tensei: Recruited to Another World",
        price: "₹305.30",
    },
    {
        img: "./bookImages/kumo_1.png",
        genre: [
            "Isekai",
            "Fantasy",
            "Action",
    ...
    {
        img: "./bookImages/eminence_in_shadow_1.png",
        genre: [
            "Isekai",
            "Fantasy",
            "Action",
    ...
    {
        img: "./bookImages/undead_adventurer_1.png",
        genre: [
            "Isekai",
            "Fantasy",
            "Action",
    ...
    {
        img: "./bookImages/last_boss_1.png",
        genre: [
            "Isekai",
            "Fantasy",
            "Action",
    ...
    {
        img: "./bookImages/campfire_1.png",
        genre: "Fantasy",
        title: "Campfire Cooking in Another World",
        price: "₹320.48",
    },
    {
        img: "./bookImages/realist_hero_1.png",
        genre: "Fantasy",
        title: "How a Realist Hero Rebuilt the Kingdom",
        price: "₹285.48",
    },
    {
        img: "./bookImages/classroom_1.png",
        genre: "School",
        title: "Classroom of Elite",
        price: "₹371.21",
    },
    {
        img: "./bookImages/Death's_daughter_1.png",
        genre: "Fantasy",
        title: "Death's Daughter & The Ebony Blade",
        price: "₹310.49",
    },
    {
        img: "./bookImages/reborn_to_master_blade_1.png",
        genre: "Fantasy",
        title: "Reborn to Master the Blade",
        price: "₹395.25",
    },
    {
        img: "./bookImages/parry_everything_1.png",
        genre: "Fantasy",
        title: "I Parry Everything...",
        price: "₹332.29",
    },
    {
        img: "./bookImages/magic_stone_gourmet_1.png",
        genre: "Fantasy",
        title: "Magic Stone Gourmet",
        price: "₹330.76",
    },
    {
        img: "./bookImages/healing_magic_1.png",
        genre: "Fantasy",
        title: "The Wrong Way to Use Healing Magic",
        price: "₹345.50",
    },
    {
        img: "./bookImages/fushi_no_kami_1.png",
        genre: "Fantasy",
        title: "Fushi no Kami",
        price: "₹278.10",
    },
    {
        img: "./bookImages/blacksmith_1.png",
        genre: "Fantasy",
        title: "My Quiet Blacksmith Life in Another World",
        price: "₹299.99",
    },
    {
        img: "./bookImages/shadow_healer_1.jpg",
        genre: "Fantasy",
        title: "The Brilliant Healers New Life in the Shadows",
        price: "₹289.99",
    },
    {
        img: "./bookImages/peddler_in_another_world_1.png",
        genre: "Fantasy",
        title: "Peddler in Another World",
        price: "₹285.40",
    },
];
